    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <form name="addGalleryForm" id="addGalleryForm" autocomplete="off" method="post" enctype="multipart/form-data">
            <div class="row">
              <div class="col-md-2"></div>
              <div class="col-md-8">
                <div class="card card-primary">
                  <div class="card-header">
                    <h3 class="card-title">Add New Gallery Details</h3>
                  </div>
                  <div class="card-body">
                    <div class="row">
      ...
      <script type="text/javascript" src="js/addGallery.js"></script>
  </body>
</html>
