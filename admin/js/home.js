  ...
  var table = $('#HomeTable').DataTable({
    ...
    "columns": [
      ...
      { 
        ...
        fnCreatedCell: function (nTd, sData, oData, iRow, iCol) {
          let bnTd = '';
           bnTd = `<a href="editHome?type=view&randomId=${oData.RANDOM_ID}" title="View"><i class="fa fa-eye" aria-hidden="true"></i></a>&nbsp;&nbsp;

            <a href="editHome?type=edit&randomId=${oData.RANDOM_ID}" title="Edit"><i class="far fa-edit" aria-hidden="true"></i></a>&nbsp;&nbsp;
